...
mod imp {
    ...
    #[template(resource = "/com/github/sidecuter/gciphers_rs/a5_1.ui")]
    pub struct GCiphersRsA51 {
        #[template_child]
    ...
    impl ObjectSubclass for GCiphersRsA51 {
        const NAME: &'static str = "GCiphersRsA51";
        type Type = super::GCiphersRsA51;
    ...
    impl ObjectImpl for GCiphersRsA51 {}
    impl WidgetImpl for GCiphersRsA51 {}
    impl BinImpl for GCiphersRsA51 {}
...
glib::wrapper! {
    pub struct GCiphersRsA51(ObjectSubclass<imp::GCiphersRsA51>)
