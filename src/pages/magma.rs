...
mod imp {
    ...
    #[template(resource = "/com/github/sidecuter/gciphers_rs/magma.ui")]
    pub struct GCiphersRsMagma {
        #[template_child]
    ...
    impl ObjectSubclass for GCiphersRsMagma {
        const NAME: &'static str = "GCiphersRsMagma";
        type Type = super::GCiphersRsMagma;
    ...
    impl ObjectImpl for GCiphersRsMagma {}
    impl WidgetImpl for GCiphersRsMagma {}
    impl BinImpl for GCiphersRsMagma {}

    #[template_callbacks]
    impl GCiphersRsMagma {
...
glib::wrapper! {
    pub struct GCiphersRsMagma(ObjectSubclass<imp::GCiphersRsMagma>)
