...
mod imp {
    ...
    use encryption::playfair::*;

    use super::*;

    #[derive(Debug, Default, gtk::CompositeTemplate)]
    #[template(resource = "/com/github/sidecuter/gciphers_rs/playfair.ui")]
    pub struct GCiphersRsPlayfair {
        #[template_child]
    ...
    impl ObjectSubclass for GCiphersRsPlayfair {
        const NAME: &'static str = "GCiphersRsPlayfair";
        type Type = super::GCiphersRsPlayfair;
    ...
    impl ObjectImpl for GCiphersRsPlayfair {}
    impl WidgetImpl for GCiphersRsPlayfair {}
    impl BinImpl for GCiphersRsPlayfair {}

    #[template_callbacks]
    impl GCiphersRsPlayfair {
...
glib::wrapper! {
    pub struct GCiphersRsPlayfair(ObjectSubclass<imp::GCiphersRsPlayfair>)
