...
mod imp {
    ...
    use encryption::vertical::*;

    use super::*;

    #[derive(Debug, Default, gtk::CompositeTemplate)]
    #[template(resource = "/com/github/sidecuter/gciphers_rs/vertical.ui")]
    pub struct GCiphersRsVertical {
        #[template_child]
    ...
    impl ObjectSubclass for GCiphersRsVertical {
        const NAME: &'static str = "GCiphersRsVertical";
        type Type = super::GCiphersRsVertical;
    ...
    impl ObjectImpl for GCiphersRsVertical {}
    impl WidgetImpl for GCiphersRsVertical {}
    impl BinImpl for GCiphersRsVertical {}

    #[template_callbacks]
    impl GCiphersRsVertical {
...
glib::wrapper! {
    pub struct GCiphersRsVertical(ObjectSubclass<imp::GCiphersRsVertical>)
